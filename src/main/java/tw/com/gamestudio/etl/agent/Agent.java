package tw.com.gamestudio.etl.agent;
...
public class Agent implements AgentListener {
    ...
    private static void usage() {
        ...
        out.println("Usage:");
        out.println();
        out.println("  java -cp openetl_[VERSION].jar tw.com.gamestudio.etl.agent.Agent -e [EXTRACT] -t [TRANSFORM] -f [FORMAT] -l [LOAD] -s [SUMMARY]");
        out.println();
        out.println("Where:");
        out.println();
